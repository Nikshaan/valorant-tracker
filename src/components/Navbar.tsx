...
const Navbar: React.FC = () => {
  return (
    <div className="bg-[#02007D] font-silkscreen border-2 z-50 border-[#C3C7CB] w-full flex justify-center items-center gap-5 h-14 sticky top-0 left-0 right-0 text-white">
        <Link to="/">
