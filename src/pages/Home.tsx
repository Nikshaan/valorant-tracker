...
const Home : React.FC = () => {
  ...
  return (
    <div className="text-white h-[100svh] bg-[#C3C7CB] relative flex flex-col items-center pb-16">
      <Navbar />
      <div style={{ backgroundImage: "url('src/assets/yoru.jpg')" }} className="m-auto border-4 border-t-[#848584] border-l-[#848584] border-b-white border-r-white bg-cover bg-center flex flex-col justify-center items-center gap-5 bg-no-repeat w-[80%] h-[50%]">
        <div className="flex flex-col bg-[#C3C7CB] p-10 px-20 justify-center items-center gap-5 border-4 border-b-black border-r-black border-t-white border-l-white">
